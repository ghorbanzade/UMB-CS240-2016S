...
\def \resDirectory {\topDirectory/src/main/c/res/ls15}
...
\begin{slide}
	...
	Access mode \alert{\texttt{w}} returns a pointer to the first byte of the file.
...
\begin{slide}
	\begin{figure}
	\includegraphics[width=0.7\textwidth]{\texDirectory/img/fread.jpg}
	\end{figure}
\end{slide}
