...
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/hw02/bmi.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/hw02/reverse.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/hw02/prime.c}
