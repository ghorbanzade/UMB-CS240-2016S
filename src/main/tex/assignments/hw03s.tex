...
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/hw03/bmi.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/hw03/reverse.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/hw03/prime.c}
