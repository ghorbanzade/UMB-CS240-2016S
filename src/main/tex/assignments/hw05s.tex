...
\doc{date-pub}{Mar 28, 2016 at 5:30 PM}
\doc{date-due}{Apr 11, 2016 at 5:30 PM}
\doc{points}{8}
...
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/hw05/fast-prime.c}
\item[] File \texttt{fast-prime.h}:
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/hw05/fast-prime.h}
\newpage
