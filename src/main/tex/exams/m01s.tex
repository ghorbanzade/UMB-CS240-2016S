...
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/m01/command-line-q.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/m01/command-line.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=22]{\topDirectory/src/main/c/m01/peak-to-peak.c}
