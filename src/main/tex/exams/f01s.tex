...
\lstinputlisting[firstline=18,lastline=35]{\topDirectory/src/main/c/f01/str2int.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=17,lastline=23]{\topDirectory/src/main/c/f01/populate.c}


\item
\texttt{while} loop should terminate once character \texttt{\textbackslash 0} is encountered.
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=16,lastline=25]{\topDirectory/src/main/c/f01/palindrome.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/f01/reverse.h}
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/f01/reverse.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=10]{\topDirectory/src/main/c/f01/fileio.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=15,lastline=19]{\topDirectory/src/main/c/f01/student.h}

\item The following function returns a student structure based on given information for a student.
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=26,lastline=33]{\topDirectory/src/main/c/f01/student.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=39,lastline=51]{\topDirectory/src/main/c/f01/student.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=20,lastline=24]{\topDirectory/src/main/c/f01/array-list.h}

Write a function with the following signature that adds a new element to the array.

\lstinputlisting[firstline=27,lastline=27]{\topDirectory/src/main/c/f01/array-list.h}

\subsection*{Solution}

\lstinputlisting[firstline=26,lastline=35]{\topDirectory/src/main/c/f01/array-list.c}
