...
\def \resDirectory {\topDirectory/src/main/c/m01}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=10]{\resDirectory/prompt-number.c}
...
\lstset{language=c,tabsize=4}
\lstinputlisting[firstline=21]{\resDirectory/single-number.c}
