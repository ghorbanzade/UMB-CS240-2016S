...
\def \topDirectory {.}
\def \resDirectory {\topDirectory/src/c/main/ls07}
...
\begin{slide}
	\begin{figure}
	\includegraphics[width=0.7\textwidth]{\imgDirectory/pulp.jpg}
	\end{figure}
\end{slide}
