...
\def \topDirectory {.}
\def \resDirectory {\topDirectory/src/c/main/ls02}
...
\begin{slide}
	...
	\column{0.4\textwidth}
	\begin{figure}
	\includegraphics[width=0.8\textwidth]{\imgDirectory/pdp7.jpg}
	\caption{PDP-7}
	\end{figure}
...
\begin{slide}
	...
	\begin{figure}
	\includegraphics[width=0.8\textwidth]{\imgDirectory/man-page.jpg}
	\end{figure}
