...
\def \topDirectory {.}
\def \resDirectory {\topDirectory/src/c/main/ls01}
...
\begin{slide}
	...
	\column{0.4\textwidth}
	\begin{figure}
	\includegraphics[width=0.8\textwidth]{\imgDirectory/bill.png}
	\end{figure}
	\end{columns}
\end{slide}
...
\begin{slide}
	...
	\begin{figure}
	\includegraphics[width=\textwidth]{\imgDirectory/gandalf.jpg}
	\end{figure}
